...
function VisualiserPortefeuille({ handelShowClose }) {
  ...
  return (
    <div className={classes.Container}>
      ...
      <div className={classes.bodyInfo}>
        ...
        <Paper className={classes.CardS}>
          <Box className={classes.ContentS}>
            <Text className={classes.titleS}>Status :</Text>
            <Text className={classes.sectitleS} sx={{color:'primary'}}>En attente </Text>
          </Box>
          <Box className={classes.ContentS}>
            <Text className={classes.titleS}>IBAN :</Text>
            <Text className={classes.sectitleS}>
...
export default VisualiserPortefeuille;
